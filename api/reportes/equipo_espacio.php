...
// Ajustar el ancho de las columnas (por ejemplo, 40 mm para cada una).
$columnWidths = array(30, 60, 60, 30); // Ajuste manual del ancho de columnas
...
if (is_array($dataEquipos) && count($dataEquipos) > 0) {
    ...
    foreach ($dataEquipos as $rowEquipo) {
        $pdf->SetX($marginLeft); // Asegurar que cada fila se mantenga centrada
